...
//			});
			// base code #1 end
			// thanhuy.nguyen modify #1 start
			if(mSocketThread.getHandler().getLooper().getThread().isAlive()){
				mSocketThread.getHandler().post(new Runnable() {
